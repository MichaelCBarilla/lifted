...
import 'package:lifted/src/common_widgets/responsive_scrollable_card.dart';
...
import 'package:lifted/src/features/authentication/presentation/sign_in/string_validators.dart';
import 'package:lifted/src/localization/string_hardcoded.dart';
import 'package:lifted/src/utils/async_value_ui.dart';
...
class _EmailPasswordSignInContentsState
  ...
  Widget build(BuildContext context) {
    ref.listen<AsyncValue>(
      ...
      (_, state) => state.showAlertDialogError(context),
    );
    final state =
